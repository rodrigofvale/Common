...
public class RandomAccessFileOriginal implements DataOutput, DataInput, Closeable {
     ...
     * @spec JSR-51
     */
    public RandomAccessFileOriginal(String name, String mode)
     ...
     * @spec JSR-51
     */
    public RandomAccessFileOriginal(File file, String mode)
        throws FileNotFoundException
    {
