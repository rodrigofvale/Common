...
public class RegularRandomAccessFile {
	private static HashMap<String, RegularRandomAccessFile> fabric = 
			new HashMap<String, RegularRandomAccessFile>(); 
	...
	public static RegularRandomAccessFile get(File file, String mode, 
		...
		RegularRandomAccessFile cachedRandomAccessFile = 
				new RegularRandomAccessFile(file, mode, cacheSize);
	...
	public static void closeAll() {
		Collection<RegularRandomAccessFile> collection = fabric.values();
	...
	public RegularRandomAccessFile(File file, String mode, int cacheBlockSize, 
			int cacheSize) throws FileNotFoundException {
	...
	public RegularRandomAccessFile(File file, String mode, int cacheSize) 
	...
	public static void main(String[] args) throws Exception {
		RegularRandomAccessFile craf1 = RegularRandomAccessFile.get(
				new File("/tmp/raf2.bin"), "rw", 1024);
		
		RegularRandomAccessFile craf2 = RegularRandomAccessFile.get(
				new File("/tmp/raf2.bin"), "rw", 1024);
